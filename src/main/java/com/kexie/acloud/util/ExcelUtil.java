...
//    }
    ...
    public static List<School> getSchoolExcelInfo(InputStream is,boolean isExcel2003){
        List<School> schoolList = null;
        try {
            if(isExcel2003){
                HSSFWorkbook wb = new HSSFWorkbook(is);
                schoolList = readSchoolExcelValue(wb);
            }
            else{
...
//    }
    ...
    private static List<School> readSchoolExcelValue(Workbook wb){
        int Rows = 0, Cols = 0;
        ...
        for(int r = 1; r < Rows;r++){
            ...
            for(int c = 0;c < Cols;c++){
                ...
                if(cell != null){
                    if(c==1){
                        school.setName(cell.getStringCellValue());//学校名称
                    }
                }
            }
